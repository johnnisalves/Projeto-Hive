...
import { Zap, Image as ImageIcon, Clock, Send, Save, Loader2, X, Heart, MessageCircle, Share, ChevronLeft, ChevronRight, Layers, Plus, Trash2, Upload, FileText, Link as LinkIcon, Wand2, ArrowRight, Sparkles, Instagram, Facebook, Linkedin, Twitter, Palette, Music2, AtSign } from 'lucide-react';

type Platform = 'INSTAGRAM' | 'FACEBOOK' | 'LINKEDIN' | 'X' | 'TIKTOK' | 'THREADS';
...
const PLATFORM_OPTIONS: { value: Platform; label: string; icon: typeof Instagram; color: string }[] = [
  ...
  { value: 'THREADS', label: 'Threads', icon: AtSign, color: 'bg-neutral-900' },
];
