...
function registerTools(server: McpServer) {
  ...
  server.tool(
    ...
    'Cria um novo brand com identidade visual completa: 6 cores (primary, secondary, accent, background, text, muted) + 3 fontes (display, heading, body)',
    {
      ...
      phone: z.string().optional().describe('Telefone/WhatsApp da empresa (ex: "(87) 99130-5450") — para usar nos criativos e legendas'),
      art_direction: z.string().optional().describe('Regras de arte da empresa aplicadas AUTOMATICAMENTE pelo diretor de arte em toda geracao de imagem (ex: "nunca mostrar forno a lenha; usar forno profissional moderno, bancada, delivery, salao")'),
